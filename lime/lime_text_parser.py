...
#////////////////////////////////////////////////////////////////////////////
    ...
    def __data_labels_distances(self,
        ...
        data = np.ones((num_samples, doc_size + 1))
        data[0] = np.ones(doc_size + 1)
        features_range = range(doc_size + 1)
...
class IndexedStringParsed(object):
    ...
    def __init__(self, raw_string, parser, bow=True,
        ...
        self.raw = raw_string
        self.parser = parser
        self.parse_tree, self.id_dict = self.get_parsing(raw_string, parser)
    ...
    def get_parsing(self, text_instance, parser):
        def organize_parse(self, pipeline_out):
            def get_branches(self, pipeline_out):
...
#////////////////////////////////////////////////////////////////////////////
    ...
    def mask_dependents(self, words_to_remove):
        ...
        to_remove_deps = depsFromHeads(self.parse_tree, words_to_remove)
    ...
    def inverse_removing(self, mask):
        ...
        """
        return ''.join([f"{self.id_dict[v]} " for v in np.flatnonzero(mask)])
