...
explain_multilang(dss["sent_leb"][0:5][1], [m.predict_proba for m in ar_models], "ar", {"post_name": "mdemo"})
explain_multilang(dss["sent_urdu"][0:5][1], [m.predict_proba for m in ur_models], "ur", {"post_name": "mdemo"})
explain_multilang(dss["sent_thai"][0:5][1], [m.predict_proba for m in th_models], "th", {"post_name": "mdemo"})
explain_multilang(dss["spam_turk"][0:5][1], [m.predict_proba for m in tr_models], "tr", {"post_name": "mdemo"})
